...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Attorney advertising, privacy, and no attorney-client relationship notices for Huang Law PLLC",
  ...
  return (
    <main className="legal-page">
      <div className="container legal-shell">
        ...
        <h1>Disclaimer</h1>
        <p>
          This website is attorney advertising for Huang Law PLLC and {site.attorney}.
        </p>
        <h2>No Attorney-Client Relationship</h2>
        <p>
          Viewing this website, submitting a contact form, sending email, or calling the firm does not create an attorney-client relationship. Representation begins only after Huang Law PLLC confirms the engagement in writing.
        </p>
